    ...
    ({
      ...
      metadata: [
        ...
        { name: "description", content: "An elegant place for sharing geoKnowledge & geoData" },
        {
          name: "keywords",
          content:
            "geo-spatial.org, GIS, teledetecție, date geospațiale, open data, date deschise, cartografie, cartografie istorică, geo, spatial, comunitate, FOSS4G, OSGeo, seminarele geo-spatial.org",
        },
        ...
        links: [
          {
            ...
            items: [
              ...
              {
                label: "YouTube",
                href: "https://www.youtube.com/@TheGeospatial",
              },
              {
                label: "Feed RSS",
