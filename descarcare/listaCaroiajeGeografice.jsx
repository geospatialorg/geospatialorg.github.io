...
const data = [
  ...
  },
  {
    name: ``,
    nameHtml: ` `,
    download: `<ul><li><a href="/.gpkg" target="_blank" rel="noopener noreferrer"><i class="fa-solid fa-hard-drive" style="margin-right: 0.4rem;"></i>GeoPackage</a></li><li><a href="/.zip" target="_blank" rel="noopener noreferrer"><i class="fa-solid fa-hard-drive" style="margin-right: 0.4rem;"></i>Shapefile</a></li><li><a href="/.parquet" target="_blank" rel="noopener noreferrer"><i class="fa-solid fa-cloud" style="margin-right: 0.4rem;"></i>Geoparquet</a></li><li><a href="/.fgb" target="_blank" rel="noopener noreferrer"><i class="fa-solid fa-cloud" style="margin-right: 0.4rem;"></i>FlatGeobuf</a></li><li><a href="/.geojson" target="_blank" rel="noopener noreferrer"><i class="fa-solid fa-hard-drive" style="margin-right: 0.4rem;"></i>GeoJSON</a></li><li><a href="/.topojson" target="_blank" rel="noopener noreferrer"><i class="fa-solid fa-hard-drive" style="margin-right: 0.4rem;"></i>TopoJSON</a></li><li><a href="/.kml" target="_blank" rel="noopener noreferrer"><i class="fa-solid fa-hard-drive" style="margin-right: 0.4rem;"></i>KML</a></li></ul>`,
    metadata: `<div><p><strong>Codul stratului:</strong> <code></code></p><div style="display: flex; align-items: flex-start; gap: 1rem;"><div style="flex: 1;"><strong>Abstract:</strong> <p><strong>Detalii specifice:</strong> <a href="" target="_blank" rel="noopener noreferrer">Procedura de prelucrare a datelor</a>.</p></div><a href="" target="_blank" rel="noopener noreferrer"><img src="" alt="thumbnail" style="width: 300px; height: auto;" /></a></div></div>`,
    resources: `<ul><li><a href="https://services.geo-spatial.org/geonetwork/srv/eng/catalog.search#/metadata/" target="_blank" rel="noopener noreferrer"><i class="fa fa-book-open" style="margin-right: 0.3rem;"></i>Consultare intrare catalog geo-spatial.org</a></li><li><a href="" target="_blank" rel="noopener noreferrer"><i class="fa-regular fa-eye" style="margin-right: 0.3rem;"></i>Vizualizare interactivă simplă</a></li><li><a href="" target="_blank" rel="noopener noreferrer"><i class="fa fa-eye" style="margin-right: 0.3rem;"></i>Vizualizare interactivă complexă</a></li><li><a href="https://services.geo-spatial.org/geoserver/grids/ows?service=WMS&version=1.3.0&request=GetCapabilities" target="_blank" rel="noopener noreferrer"><i class="fa-solid fa-map" style="margin-right: 0.3rem;"></i>Accesare WMS</a></li><li><a href="https://services.geo-spatial.org/geoserver/grids/gwc/service/wmts?service=WMTS&version=1.1.1&request=GetCapabilities" target="_blank" rel="noopener noreferrer"><i class="fa-solid fa-map" style="margin-right: 0.3rem;"></i>Accesare WMTS</a></li><li><a href="https://services.geo-spatial.org/geoserver/grids/ows?service=WFS&acceptversions=2.0.0&request=GetCapabilities" target="_blank" rel="noopener noreferrer"><i class="fa-regular fa-map" style="margin-right: 0.3rem;"></i>Accesare WFS</a></li></ul>`,
  },
];
