...
<figure style={{ textAlign: "center" }}>
  <img src={useBaseUrl('/img/ghiduri/procesari-etl/limite-administrative/ro_admin_lau_polygon.svg')} alt="Limite administrative - UAT, România (poligon)" />
</figure>
...
De asemenea, au fost expune prin intermediul serviciilor standardizate OGC. Stratul poate fi găsit sub numele `ro_admin_lau_polygon` în documentele getCapabilities pentru:
