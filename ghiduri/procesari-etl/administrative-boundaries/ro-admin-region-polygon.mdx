...
<figure style={{ textAlign: "center" }}>
  <img src={useBaseUrl('https://services.geo-spatial.org/data/thumbnails/administrative-boundaries/county/ro-admin-region-polygon.svg')} alt="Limite administrative - Regiuni dezvoltare, România (poligon)" />
</figure>
