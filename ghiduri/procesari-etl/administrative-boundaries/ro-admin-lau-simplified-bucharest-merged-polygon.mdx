...
# UAT, România  (poligon, geometrie unificată și simplicata București)
...
<figure style={{ textAlign: "center" }}>
  <img src={useBaseUrl('https://services.geo-spatial.org/data/thumbnails/administrative-boundaries/lau/ro-admin-lau-simplified-bucharest-merged-polygon.svg')} alt="Limite administrative - UAT, România  (poligon, geometrie unificată și simplificată București)" />
</figure>
...
##############################################################################################################
#🛠 Publicare/actualizare UAT (poligon, geometrie unificată și simplificată București)
##############################################################################################################
...
gs_layer_title="Limite administrative - UAT, România  (poligon, geometrie unificată și simplificată București)"
...
echo "
🛠  Procesare UAT poligon București comasat geometrie simplificată
"
