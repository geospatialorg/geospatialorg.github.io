...
<figure style={{ textAlign: "center" }}>
  <img src='https://services.geo-spatial.org/data/thumbnails/administrative-boundaries/lau/ro_admin_lau_simplified_polygon.svg' alt="Limite administrative - UAT, România (poligon)" />
</figure>
