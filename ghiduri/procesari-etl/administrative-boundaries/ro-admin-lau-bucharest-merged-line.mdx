...
# UAT, România  (linie, geometrie unificată București)
...
<figure style={{ textAlign: "center" }}>
  <img src={useBaseUrl('https://services.geo-spatial.org/data/thumbnails/administrative-boundaries/lau/ro-admin-lau-bucharest-merged-line.svg')} alt="Limite administrative - UAT, România  (linie, geometrie unificată București)" />
</figure>
