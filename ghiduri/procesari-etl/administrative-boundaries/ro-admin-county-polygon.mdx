...
<figure style={{ textAlign: "center" }}>
  <img src={useBaseUrl('https://services.geo-spatial.org/data/thumbnails/administrative-boundaries/lau/ro-admin-county-polygon.svg')} alt="Limite administrative - Județe, România (poligon)" />
</figure>
